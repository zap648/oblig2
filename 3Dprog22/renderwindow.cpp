...
//    mVmatrix->translate(0, 0, 5);
    mCamera.lookAt(QVector3D{2.5f, 2.5f, 2.5f}, QVector3D{0.0f, 0.0f, 0.0f}, QVector3D{0.0f, 1.0f, 0.0f});
    mCamera.update();
    ...
    if (mia)
    {
        ...
        if (controller.moveUp) mia->move(0.0f, 0.1f, 0.0f);
        if (controller.moveDown) mia->move(0.0f, -0.1f, 0.0f);
    }
}
